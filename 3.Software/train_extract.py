...
FOLDER_PATH = r'3.Software/Data/training_data'  # This will look for wooting folder in the same directory as this script
...
def main():
    ...
    if all_peak_data:
        ...
        df.to_csv('3.Software\wooting_peak_data2.csv', index=False)
        print(f"\nPeak data saved to '3.Software\wooting_peak_data.csv' ({len(all_peak_data)} samples)")
